...
(function( $ ){
	...
	var methods = {
		...
		imageWidget: function(){
			...
			chooseFrom.append(chooseFromLocal);
			chooseFromLocal.on('change', handleFileSelect);
			uploadImageBar.append(chooseFrom);
							 ...
							 'font_size': {	"select":true,
							  ...
							  'color'	: { "text":"A",
											...
											"custom":function(button){
													...
													var palette       = $('<ul />',{id:"color_ui"}).append($('<li />').css({"width":"145px","display":"Block","height":"25px"}).html('<div>文本颜色</div>'));
