...
<script>
    ...
    function searchYuyue() {
        $("#searchform").attr("action","margin-list");
        document.getElementById("searchform").submit();
    }

    function submitBeforeMonthMargin(){
        var shop = $("#shop option:selected").val();
        var yes = confirm("确定结算该门店上个月分成么？");
        if (yes) {
            $.post("/admin/divided-details/submit-last-month-margin",{"shopId":shop},
                function(data){
                    if (data.code == 1) {
                        alert("结算完成");
                    }else{
    ...
    function daochu(){
        $("#searchform").attr("action","export-margin");
        $("#searchform").submit();
    }
...
<div style="margin-left: 1%;margin-top: 1%">
    <div class="row">
        ...
        <div class="col-lg-12">
            <form class="form-inline" action="margin-list" method="post" role="form" id="searchform">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input style="display:none" id="fencheng" type="button" class="btn btn-success" onclick="submitBeforeMonthMargin()" value="结算履约保证金">
                    <?php } ?>
    ...
    <table class="table table-bordered table-hover">
        ...
        <?php } ?>
            <tr class="danger" align="center">
                ...
                <td align="center" style="vertical-align:middle;"></td>
                <td align="center" style="vertical-align:middle;"><font color="#FF6600">
                <?php echo round($heji['heji'],2);?></font></td>
                <td align="center" style="vertical-align:middle;"></td>
                <td></td>
                <td align="center" style="vertical-align:middle;"><font color="#FF6600">
