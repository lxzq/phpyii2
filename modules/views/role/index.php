  ...
  <div class="main_body">
      <div class="span9 page_message">
          <section id="contents">
                        <div class="table-bar">
                  <div class="fl">
                      <div class="tools"> <a href="javascript:void(0);" onclick="add()" class="btn add_role">新增</a> &nbsp;
                          <a href="javascript:void(0);" class="btn edit_role">修改</a> &nbsp;
                          <a href="javascript:void(0);" class="btn del_role">删除</a> &nbsp;
                      </div>
                  </div>
      ...
      <script type="text/javascript">
          ...
          $('.add_role').click(function(){
              window.location = "/admin/role/edit";
          });
          ...
          $('.edit_role').click(function(){
              ...
              window.location = "/admin/role/edit?id="+menuid;
          })
          $('.del_role').click(function()
          {
              ...
              if (window.confirm('确定要删除吗?')) {
                  window.location = "/admin/role/delete?" + query;
                  return true;
              } else {
                  return false;
              }
